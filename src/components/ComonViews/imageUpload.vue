<!--
 * @Author: QKSword
 * @Date: 2022-04-03 15:20:21
 * @LastEditTime: 2022-04-23 10:15:06
 * @LastEditors: Please set LastEditors
 * @Description: 上传图片组件
 * @FilePath: \gkattack-front\src\components\ComonViews\imageUpload.vue
-->
...
<template>
  <div class="input-group" @dragover="fileDragover" @drop="fileDrop">
    <el-upload
      ...
      :file-list="fileList"
    >
      <el-button type="gray-el-button" icon="el-icon-upload2">选择图片/拖拽图片</el-button>
  ...
  methods: {
    ...
    fileDrop(e) {
      ...
      reader.onload = r => {
        ...
        this.privateString = r.currentTarget.result
